...
class WASISysroot(product.Product):
    ...
    def _build_target(self, host_target, enable_wasi_threads, compiler_rt_os_dir, target_triple):
        ...
        sysroot_build_path = WASISysroot.sysroot_build_path(
        ...
        # Build compiler-rt first and pass the built builtins archive to wasi-libc.
        ...
        builtins_lib_path = os.path.join(
            compiler_rt_build_dir, 'lib', compiler_rt_os_dir, 'libclang_rt.builtins-wasm32.a')
    ...
    def _build_wasi_libc(self, wasi_libc_build_dir, target_triple, build_root,
        ...
        cmake.install_with_cmake(
            ['install'],
            WASISysroot.sysroot_install_path(build_root, target_triple))
