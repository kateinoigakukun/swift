...
@extern(c) @usableFromInline
@available(SwiftStdlib 5.1, *)
internal func swift_retainCount(_: UnsafeMutableRawPointer) -> Int
@extern(c) @usableFromInline
@available(SwiftStdlib 5.1, *)
internal func swift_unownedRetainCount(_: UnsafeMutableRawPointer) -> Int
@extern(c) @usableFromInline
@available(SwiftStdlib 5.1, *)
internal func swift_weakRetainCount(_: UnsafeMutableRawPointer) -> Int
